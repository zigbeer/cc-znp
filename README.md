...
* Commands  
    ...
    | ZDO_EXT_NWK_INFO                 | extNwkInfo               | SREQ | `{ }`                                                                                                                   | `{ nwkdevaddress, devstate, nwkpanid, nwkcoordaddress, extendedpanid, nwkcoordextaddress, nwklogicalchannel }` |
...
* Indication  
    ...
    | ZDO_STATE_CHANGE_IND     | AREQ         | stateChangeInd    | `{ state }`                                                                                                                                                                                               |
